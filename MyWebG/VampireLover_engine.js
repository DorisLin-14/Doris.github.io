...
function run(scene) {
  ...
  function runNext() {
    ...
    if (line.startsWith("[")) {
      ...
      const overlay = document.getElementById("overlay");
      const isOverlay = (scene === "intro") || overlay.style.display === "block";
      const displayBox = (scene === "intro") ? document.getElementById("overlay-text")
                                             : (isOverlay ? document.getElementById("overlay-text")
