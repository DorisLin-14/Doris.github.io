...
function run(scene) {
  ...
  function runNext() {
    ...
    if (line.startsWith("[")) {
      ...
      const isOverlay = overlay.style.display === "block";
      const displayBox = isOverlay ? document.getElementById("overlay-text") : document.getElementById("dialogue");
